...
X = np.load('2_sequence_train_data.npy')
...
hidden = Dense(units=hidden_units,activation="relu")(input)
hidden2 = Dense(units=hidden_units*2,activation="relu")(hidden)
outputs = Dense(units=classes,activation="softmax")(hidden2)
